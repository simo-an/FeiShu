...
const forestTheme: GlobalTheme = {
  name: 'forest',
  common: commonForest,
}

Reflect.ownKeys(lightTheme).forEach(component => {
  forestTheme[component] = {
...
Reflect.ownKeys(lightTheme).forEach(component => {
  ...
  forestTheme[component].peers = {}

  Reflect.ownKeys(lightTheme[component].peers).forEach(peerComponent => {
    forestTheme[component].peers[peerComponent] = forestTheme[peerComponent]
  })
})
