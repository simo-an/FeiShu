...
const base = {
  ...
  // primary
  primaryHover: '#b9593d',
  primaryDefault: '#b93b16',
  primaryActive: '#752108',
  primarySuppl: '#bb4d2d',
  primarySelected: '#efe2de',
...
const autumnTheme: GlobalTheme = {
  name: 'forest',
  common: commonAutumn,
}

Reflect.ownKeys(lightTheme).forEach(component => {
  autumnTheme[component] = {
...
Reflect.ownKeys(lightTheme).forEach(component => {
  ...
  autumnTheme[component].peers = {}

  Reflect.ownKeys(lightTheme[component].peers).forEach(peerComponent => {
    autumnTheme[component].peers[peerComponent] = autumnTheme[peerComponent]
  })
})
